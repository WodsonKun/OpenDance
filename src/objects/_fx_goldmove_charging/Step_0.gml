...
if (!animation_complete) {
    ...
    if (animation_frame >= (sprite_get_number(_fx_goldeffect_charge) - 1)) {
        animation_frame = (sprite_get_number(_fx_goldeffect_charge) - 1); // Set to the last frame
        animation_complete = true; // Mark animation as complete
    }
    
    // Update the sprite or visual representation based on the current frame
    sprite_index = _fx_goldeffect_charge; // Replace with your animation sprite
